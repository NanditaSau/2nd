               ...
               <div class="card">
                   <div class="card-body" style="background-color:#03fcf8">
                        <div class="mt-2 text-center">
                         ...
                         <div class="mt-4">
                           <form action="buser" method="post">
                             <div class="form-group">
                                 <label for="email" class="text-uppercase font-weight-bold text-primary">Username</label>
                                 <input type="text" class="form-control" id="email" name="email" placeholder="Enter Your Email Id" required="required" onblur="checkname()" onfocus= "clearname()">
                                 <div class="text-danger font-weight-bold" id="emailiderrormessage"></div>
                             </div>
                              <div class="form-group">
